    ...
    "": {
      ...
      "version": "0.1.11"
          ...
          rb-registry-lib = pkgs.buildRubyGem {
            ...
            version = "0.1.11";
            src = pkgs.fetchurl {
              url = "https://rubygems.org/downloads/monarchic-agent-protocol-0.1.11.gem";
          ...
          java-registry-lib = pkgs.fetchurl {
            url = "https://jitpack.io/com/github/monarchic-ai/monarchic-agent-protocol/v0.1.11/monarchic-agent-protocol-v0.1.11.jar";
          ...
          #   url = "https://pub.dev/packages/monarchic_agent_protocol/versions/0.1.11.tar.gz";
          ...
          csharp-registry-lib = pkgs.fetchurl {
            url = "https://api.nuget.org/v3-flatcontainer/monarchic.agentprotocol/0.1.11/monarchic.agentprotocol.0.1.11.nupkg";
          ...
          go-import = pkgs.buildGoModule
            (let
              goModImport = pkgs.runCommand "go-import-src" {} ''
                ...
                require (
                  github.com/monarchic-ai/monarchic-agent-protocol/src/go v0.1.11
